...
if __name__ == "__main__":
    ...
    old_data = [DiffDict(e) for e in overpass_query('nwr[shop][name~"Espaça?o [CK]asa"](area.country);')]

    for nd in new_data:
        public_id = nd["id"]
        branch = html.unescape(re.sub(r"^(MyShop )?Espaço Casa ", "", nd["store"], flags=re.I)).replace("–", "-")
