...
CITY_LOC_FIXES = {
    ...
    "Combatentes Ultramar": "Combatentes de Ultramar",
    ...
    "Keil Amaral": "Keil do Amaral",
    "Lg Carlos Pato": "Largo Carlos Pato",
    ...
    "Qta Adro": "Quinta do Adro",
    "Qta Anjo": "Quinta do Anjo",
    "Qta Campo": "Quinta do Campo",
    "Qta Grande": "Quinta Grande",
